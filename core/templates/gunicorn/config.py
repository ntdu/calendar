...
from ..settings import GunicornSetting

#
#   To use this config
# gconfig: Dict = create_gunicorn_config(settings)
...
def create_gunicorn_config(settings: GunicornSetting = GunicornSetting()):
    ...
    use_accesslog = accesslog_var or None   # noqa  # NOSONAR
    errorlog_var = os.getenv("ERROR_LOG", os.path.join(log_dir, 'error.log'))
    use_errorlog = errorlog_var or None     # noqa  # NOSONAR
